...
b,a =  signal.cheby1(5,3, 1000/(Frequency/2),btype='highpass')
...
c,d = signal.cheby1(5,3, 380/(Frequency/2),btype='lowpass') # ButterWorth low-filter
...
write("NewSound-chebysev.wav", Frequency, newFilteredSignal)